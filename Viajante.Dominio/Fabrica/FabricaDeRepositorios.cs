...
namespace Viajante.Dominio.Fabrica
{
    public class FabricaDeRepositorios<T> where T : class
    {
        ...
        {
            System.Reflection.Assembly assembly = System.Reflection.Assembly.Load("Viajante.Persistencia");
           
            //var assembly = System.Reflection.Assembly.Load(ns);
            string ns = "Viajante.Persistencia.Repositorio";
